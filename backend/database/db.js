...
const MIGRATIONS = [
  ...
  path.join(__dirname, 'migrations/017_session_break_seconds.sql'),
  ...
  path.join(__dirname, 'migrations/027_study_groups.sql'),
  path.join(__dirname, 'migrations/028_meeting_link.sql'),
];
